...
const initialState = {
  ...
  mode: 'interactive',
  bulkPatents: ['US1234567B2', 'US1234567B2', 'US1234567B2'],
  history: [
  ...
  projects: [
    { id: 'US6421675B1', status: 'Processing', mode: 'Bulk', created: 'Sep 25, 2025' },
    { id: 'US6421675B1', status: 'Complete', mode: 'Quick', created: 'Sep 25, 2025' },
    { id: 'US6421675B1', status: 'Rejected', mode: 'Bulk', created: 'Sep 25, 2025' },
    { id: 'US6421675B1', status: 'Processing', mode: 'Bulk', created: 'Sep 25, 2025' },
    { id: 'US6421675B1', status: 'Complete', mode: 'Quick', created: 'Sep 25, 2025' },
  ]
};
...
const analysisSlice = createSlice({
  ...
  reducers: {
    ...
    removeBulkPatent: (state, action) => {
      state.bulkPatents = state.bulkPatents.filter((_, index) => index !== action.payload);
    }
  }
});

export const { toggleSidebar, setCurrentView, setMode, addBulkPatent, removeBulkPatent } = analysisSlice.actions;
