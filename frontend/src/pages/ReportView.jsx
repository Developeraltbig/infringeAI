...
const reportData = {
  ...
  tabs: [
    ...
    { id: 3, label: "MICROSOFT CORPORATIONMicrosoft SharePoint Search", active: false }
  ],
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto flex flex-col gap-4 p-4 animate-fade-in pb-20">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <h1 className="text-xl font-bold text-gray-900">Patent Infringement Claim Chart</h1>
      ...
      <div className="flex flex-col shadow-sm rounded-xl border border-gray-100">
        ...
        <div 
          ...
          className={`bg-white p-5 flex justify-between items-center cursor-pointer hover:bg-gray-50 transition-colors ${
            isOtherProductsOpen ? 'rounded-t-xl border-b border-gray-100' : 'rounded-xl'
          }`}
        >
          <h3 className="text-[15px] font-bold text-gray-900">
            Other Alphabet Inc. Products Analysed ({reportData.otherProducts.length})
          </h3>
          <ChevronDown 
            size={20} 
          ...
          <div className="bg-[#fcfcfc] rounded-b-xl flex flex-col divide-y divide-gray-100/50">
            {reportData.otherProducts.map((product) => (
              <div key={product.id} className="p-6 md:p-8 flex flex-col gap-3">
                {/* Stylized Number */}
                <span className="text-3xl font-light text-[#ffb076] leading-none select-none mb-1" style={{ fontFamily: 'serif' }}>
                  {product.id}
                </span>
          ...
          {reportData.claimElements.map((row, index) => (
            <div 
              ...
              className={`grid grid-cols-1 lg:grid-cols-12 gap-8 pb-8 ${
                index !== reportData.claimElements.length - 1 ? 'border-b border-gray-200/60' : ''
              }`}
            >
              ...
              <div className="lg:col-span-4 flex flex-col gap-2">
                {index === 0 && <span className="text-[13px] font-bold text-gray-900 mb-1">Product Analysis</span>}
              ...
              <div className="lg:col-span-4 flex flex-col gap-2">
                {index === 0 && <span className="text-[13px] font-bold text-gray-900 mb-1">Evidence</span>}
                ...
                <div className="bg-[#fffcf7] border border-[#ffeed3] rounded-xl p-5 flex flex-col gap-3 mt-auto">
                  ...
                  <div className="flex flex-col gap-2">
                    {row.sources.map((source, sIdx) => (
                      <div key={sIdx} className="bg-white border border-gray-100 rounded flex items-center justify-between p-2 shadow-sm">
              ...
              <div className="lg:col-span-1 flex flex-col gap-2">
                {index === 0 && <span className="text-[13px] font-bold text-gray-900 mb-1">Status</span>}
