...
const Processing = () => {
  ...
  const [statusText, setStatusText] = useState("Identifying Target Product Documentation...");
    ...
    <div className="w-full max-w-5xl mx-auto animate-fade-in pb-12">
      <div className="bg-white rounded-[24px] shadow-[0_4px_20px_rgb(0,0,0,0.03)] border border-gray-100 px-8 py-14 md:px-16 md:py-16 flex flex-col items-center">
        ...
        <p className="text-gray-500 text-[15px] text-center max-w-3xl leading-relaxed mb-10">
          Your Interactive Mode Infringement Analysis Is In Progress. We're Thoroughly Examining Potential
          Infringements Across Multiple Products. This Typically Takes 12 Minutes.
        </p>
        ...
        <div className="w-full bg-[#fafbfc] border border-gray-100 rounded-[16px] p-8 md:p-10 flex flex-col items-center mb-8">
          ...
          <div className="text-center flex flex-col gap-2">
            <span className="text-gray-500 text-[15px]">
              Estimated Time Remaining: <span className="text-[#ff6b00] font-semibold">{timeRemaining}</span>
            </span>
            <span className="text-gray-500 text-[14px]">
              You'll Receive An Email Notification Once The Infringement Analysis Is Complete.
            </span>
          </div>
        </div>
