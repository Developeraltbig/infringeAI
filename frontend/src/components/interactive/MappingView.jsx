      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-10">
        ...
        <div className="flex flex-col gap-8">
          {mappings.map((item, index) => (
            <div
              key={index}
              className="bg-[#fafbfc] border border-gray-100 rounded-[32px] p-8 md:p-12 flex flex-col md:flex-row gap-10 md:gap-16 group hover:border-orange-200 transition-colors"
            >
              ...
              <div className="w-full md:w-2/3 flex flex-col gap-10 border-l border-gray-100 pl-0 md:pl-12">
                {/* Explanation Block */}
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-4">
                    {/* Assuming specSupport might be a string of quotes or an array */}
                    <p className="text-gray-400 text-[13px] leading-relaxed italic bg-white p-4 rounded-2xl border border-gray-50 shadow-sm">
                      {item.specSupport}
                    </p>
                  </div>
                </div>
